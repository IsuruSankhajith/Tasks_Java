...
def get_score():
    ...
    players = int(input('how many players are there(1..4)  :')) #input players for the game
...
def dice_rules():
    ...
    print('* Each player getting sum of ')
    print('  points highs score win')
